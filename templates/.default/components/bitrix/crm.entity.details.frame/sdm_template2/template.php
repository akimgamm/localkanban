...
$userUSresult = $rsUsers->arResult;
$userUS = $userUSresult[0]['LAST_NAME'] . " " . $userUSresult[0]['NAME'];
//print_r($userUS); ?>
					<div style="font-size:12px;"><a target="_blank" href="https://dstinfo.ru/bit/?z=Сделка №<? echo $arResult['ENTITY_ID']; ?> — <?$APPLICATION->ShowTitle()?>&us=<? echo $userUS; ?>">Добавить в каталог</a></div>
				</div>
			</div>
		</div>
	</div>
