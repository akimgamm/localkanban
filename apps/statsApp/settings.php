<?php
define('C_REST_CLIENT_ID','local.610a1a3b6b3f24.66225693');//Application ID
define('C_REST_CLIENT_SECRET','SiY3N0sqQGATcVGIJ3fwX2bTQY6knMQv3h94UUmfMEY9CZwYsg');//Application key
// or
