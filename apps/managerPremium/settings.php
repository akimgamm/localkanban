<?php
define('C_REST_CLIENT_ID','local.6151aab07b8ad4.29037471');//Application ID
define('C_REST_CLIENT_SECRET','rlhHRnL6KfMIATLPSSV9MiBSN5tLZKfbhpft3H2RGnJZyuCS66');//Application key
// or
